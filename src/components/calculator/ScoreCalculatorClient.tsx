...
export function ScoreCalculatorClient() {
  ...
  /**
   * Calculate Reading & Writing score - Albert.io style
   *
   * M1 + M2 qo'shiladi, keyin conversion table'dan scaled score olinadi
   * Based on: https://www.albert.io/blog/sat-score-calculator/
   */
  const calculateReadingWritingScore = (
    module1: number,
    module2: number
  ): number => {
    // Albert.io style: Total raw score qo'shiladi
    const totalRaw = module1 + module2;
    // Conversion table'dan scaled score olinadi
    const score = getScoreFromTable(digitalSATReadingWritingTable, totalRaw);
    return score;
  };
