/**
 * Read Math Excel file correctly - M1 va M2 o'rnini to'g'ri aniqlash
 */
...
console.log('const digitalSATMath2DTable: { [m1: number]: { [m2: number]: number } } = {');
...
// Save as JSON
const jsonFile = path.join(__dirname, '../math_table_correct.json');
